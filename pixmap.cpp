...
Dot::Dot(const int x, const int y,
    ...
    : QObject(), QGraphicsItem (), /*QGraphicsRectItem (),*/ _x(x), _y(y), _imgX(imgX), _imgY(imgY), _state(false) {
...
Dot::Dot()
    : QObject(), QGraphicsItem (), /*QGraphicsRectItem (),*/ _x(0), _y(0), _imgX(0), _imgY(0), _state(false) {
    mRect.setTopLeft(QPointF(_imgX, _imgY));
    mRect.setBottomRight(QPointF(_imgX + width, _imgY + height));
    mPen = new QPen(Qt::black, 0.5);
    mPen->setBrush(Qt::white);
...
Dot::Dot(const int x, const int y)
    : QObject (), QGraphicsItem (), /*QGraphicsRectItem (),*/ _x(x), _y(y) {
    mRect.setTopLeft(QPointF(_imgX, _imgY));
    mRect.setBottomRight(QPointF(_imgX + width, _imgY + height));
    mPen = new QPen(Qt::black, 0.5);
    mPen->setBrush(Qt::white);
